      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="glass-panel w-full max-h-[88vh] overflow-y-auto styled-scrollbar rounded-t-[2rem] border border-white/10 p-6 pb-[calc(env(safe-area-inset-bottom,0px)+1.5rem)]"
          >
