...
// v5: иконки PWA собираются генератором заново (монокромный трафарет +
// крупнее эмблема в maskable) и в кэш добавлены новые файлы. Версию
// ОБЯЗАТЕЛЬНО поднимать при смене иконок: статика отдаётся cache-first,
// иначе установленное приложение продолжает показывать иконки из старого
// кэша — например, со светлой подложкой вокруг логотипа.
const CACHE_NAME = "dsu-debate-shell-v5";
const SHELL_URLS = [
  "/",
